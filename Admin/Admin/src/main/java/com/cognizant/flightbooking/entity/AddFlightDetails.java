...
public class AddFlightDetails {
	...
	public AddFlightDetails(Integer id, Integer flightNumber, String operatingAirlines, String fromPlace,
			...
			Integer nonBusinessSeats, Double cost, Date dateOfDeparture, boolean block) {
		super();
		this.id = id;
	...
	public AddFlightDetails(Integer flightNumber, String operatingAirlines, String fromPlace, String toPlace,
